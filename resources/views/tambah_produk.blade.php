    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-12 mx-auto">
        <div class="card z-index-0 fadeIn3 fadeInBottom">
          ...
          <div class="card-body">
            <form role="form" class="text-start" method="POST" action="{{route('produk.store')}}" enctype="multipart/form-data">
                @csrf
              <div class="input-group input-group-outline my-3">
                <label class="form-label">Masukkan Nama Produk</label>
              ...
              <div class="input-group input-group-outline my-3">
                <textarea name="deskripsi" placeholder="Masukkan Deskripsi Produk" class="form-control" required></textarea>
              </div>
              <div class="input-group input-group-outline my-3">
              ...
              <div class="text-center">
                ...
                <a href="{{route('produk')}}" class="btn bg-gradient-outline-info w-100 my-4 mb-2">Batal</a>
              </div>
            </form>
          </div>
        </div>
